...
RSpec.describe InitiativesController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested initiative as @initiative" do
      initiative = Initiative.create! valid_attributes
      get :show, params: {id: initiative.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested initiative as @initiative" do
      initiative = Initiative.create! valid_attributes
      get :edit, params: {id: initiative.to_param}, session: valid_session
      expect(assigns(:initiative)).to eq(initiative)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Initiative" do
        expect {
          post :create, params: {initiative: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved initiative as @initiative" do
        post :create, params: {initiative: invalid_attributes}, session: valid_session
        expect(assigns(:initiative)).to be_a_new(Initiative)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested initiative" do
        initiative = Initiative.create! valid_attributes
        put :update, params: {id: initiative.to_param, initiative: new_attributes}, session: valid_session
        initiative.reload
      ...
      it "assigns the requested initiative as @initiative" do
        initiative = Initiative.create! valid_attributes
        put :update, params: {id: initiative.to_param, initiative: valid_attributes}, session: valid_session
        expect(assigns(:initiative)).to eq(initiative)
      end
    ...
    context "with invalid params" do
      it "assigns the initiative as @initiative" do
        initiative = Initiative.create! valid_attributes
        put :update, params: {id: initiative.to_param, initiative: invalid_attributes}, session: valid_session
        expect(assigns(:initiative)).to eq(initiative)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested initiative" do
      initiative = Initiative.create! valid_attributes
      expect {
        delete :destroy, params: {id: initiative.to_param}, session: valid_session
      }.to change(Initiative, :count).by(-1)
    end
